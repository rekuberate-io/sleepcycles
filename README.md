...
Define sleep & wake up schedules for your Kubernetes Deployments. Automatically shutdown deployments that occupy resources in your cluster and wake up only when you need them, reducing that way the overall energy consumption.
